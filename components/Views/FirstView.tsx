...
function FirstView() {
  return (
    ...
    />
    <h1 className="absolute  text-md font-sans leading-5 transform -translate-x-1/2 -translate-y-1/2" style={{top: "55%", left: "25%"}}>
      COMMUNITY LED WEB3
      <br />
      LAUNCHPAD FOR
      <br />
    ...
    <h1 className="absolute text-md font-sans leading-5 transform -translate-x-1/2 -translate-y-1/2" style={{top: "70%", right: "10%"}}>
